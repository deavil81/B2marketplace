                        ...
                        <ul class="navbar-nav ms-auto">
                            ...
                            @auth
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                                        <li>
                                            <a class="dropdown-item" href="{{ auth()->user()->role === 'buyer' ? route('buyer.dashboard') : route('seller.dashboard') }}">
                                                <i class="fas fa-tachometer-alt"></i> Dashboard
                                            </a>
                                        </li>
                                        @if(auth()->user()->role === 'seller')
                                            <li>
                                                <a class="dropdown-item" href="{{ route('manufacturers.list') }}">
                                                    <i class="fas fa-file-alt"></i> View RFQs
                                                </a>
                                            </li>
                                        @endif
                                        ...
                                        <li>
                                            ...
                                            href="{{ Auth::user()->role === 'buyer' ? route('profile.buyer') : route('profile.edit') }}">
                            ...
                            @else
                                <li class="nav-item dropdown">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                                        <li><a class="dropdown-item" href="{{ route('home') }}"><i class="fas fa-home"></i> Home Page</a></li>
                                        <li><a class="dropdown-item" href="{{ route('about') }}"><i class="fas fa-info-circle"></i> About</a></li>
                                        <li><a class="dropdown-item" href="#contact"><i class="fas fa-envelope"></i> Contact</a></li>
                                        <li><hr class="dropdown-divider"></li>

...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/detailed_registration.css')); ?>">
</head>
<body class="register-page">
    <div class="container-register100">
        <div class="wrap-register100">
            <form class="register100-form validate-form" action="<?php echo e(route('register.details.store')); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                <span class="register100-form-title">Business Registration</span>

                <!-- Hide email, password, and role fields -->
                <input type="hidden" name="email" value="<?php echo e($initialData['email'] ?? old('email')); ?>">
                <input type="hidden" name="password" value="<?php echo e($initialData['password'] ?? old('password')); ?>">
                <input type="hidden" name="password_confirmation" value="<?php echo e($initialData['password_confirmation'] ?? old('password_confirmation')); ?>">
                <input type="hidden" name="role" value="<?php echo e($initialData['role'] ?? old('role')); ?>">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" id="about_us" name="about_us" placeholder="Tell us about your company" rows="4" required><?php echo e(old('about_us')); ?></textarea>
                </div>
...
<?php /**PATH C:\online-marketplace\resources\views/auth/register.blade.php ENDPATH**/ ?>
    ...
    <div class="row">
        ...
        <div class="col-md-3">
            <div class="list-group">
                ...
                <a href="<?php echo e(route('about')); ?>" class="list-group-item list-group-item-action active">About Us</a>
                <a href="#contact" class="list-group-item list-group-item-action">Contact</a>
                <a href="<?php echo e(route('dashboard')); ?>" class="list-group-item list-group-item-action">Dashboard</a>
                <a href="<?php echo e(route('settings')); ?>" class="list-group-item list-group-item-action">Settings</a>
        ...
        <div class="col-md-9">
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-4">
                    <img src="<?php echo e(asset('images/mission.jpg')); ?>" class="img-fluid rounded" alt="Our Mission">
                </div>
            </div>

            <div class="row">
                <div class="col-md-6 mb-4">
                    <img src="<?php echo e(asset('images/features.jpg')); ?>" class="img-fluid rounded" alt="Features">
                </div>
                <div class="col-md-6 mb-4">
                    <h2>Features</h2>
                    <ul>
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-4">
                    <img src="<?php echo e(asset('images/why-choose-us.jpg')); ?>" class="img-fluid rounded" alt="Why Choose Us">
                </div>
            </div>
...
<?php echo $__env->make('layouts.navlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\online-marketplace\resources\views/about.blade.php ENDPATH**/ ?>